            ...
            <div class="col-xxl-4 col-lg-5">
                    ...
                    <div class="card-body p-4">
                        <div class="text-center w-75 m-auto">
                            ...
                            <p class="text-muted mb-4">
                                <?= $lang->require('registration_about') ?>
                            </p>
                        </div>
                        ...
                        <form action="?" method="post">
                            ...
                            <div class="mb-3">
                                <label for="last_name" class="form-label">
                                    <?= $lang->require('last_name') ?>
                                </label>
                                <input class="form-control <?= (isset($page->errors['last_name']) ? 'is-invalid' : '') ?>"
                                       type="text" id="last_name" name="last_name"
                                       value="<?= $input->getString('last_name', true) ?>"
                                       placeholder="<?= $lang->require('enter_your_last_name') ?>">
                                <?php if (isset($page->errors['last_name'])): ?>
                                    <div class="invalid-feedback">
                                        <?= htmlspecialchars($page->errors['last_name']) ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="first_name" class="form-label">
                                    <?= $lang->require('first_name') ?>
                                </label>
                                <input class="form-control <?= (isset($page->errors['first_name']) ? 'is-invalid' : '') ?>"
                                       type="text" id="first_name" name="first_name" required
                                       value="<?= $input->getString('first_name', true) ?>"
                                       placeholder="<?= $lang->require('enter_your_first_name') ?>">
                                <?php if (isset($page->errors['first_name'])): ?>
                                    <div class="invalid-feedback">
                                        <?= htmlspecialchars($page->errors['first_name']) ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="middle_name" class="form-label">
                                    <?= $lang->require('middle_name') ?>
                                </label>
                                <input class="form-control <?= (isset($page->errors['middle_name']) ? 'is-invalid' : '') ?>"
                                       type="text" id="middle_name" name="middle_name"
                                       value="<?= $input->getString('middle_name', true) ?>"
                                       placeholder="<?= $lang->require('enter_your_middle_name') ?>">
                                <?php if (isset($page->errors['middle_name'])): ?>
                                    <div class="invalid-feedback">
                                        <?= htmlspecialchars($page->errors['middle_name']) ?>
                                    </div>
                                <?php endif; ?>
                            </div>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p class="text-muted">
                            <?= $lang->require('already_have_an_account') ?>
                            <a href="<?= Controller::getUrl($lang, 'authorization') ?>" class="text-muted ms-1">
                                <b><?= $lang->require('log_in') ?></b>
                            </a>
                        </p>
                    </div> <!-- end col -->
                </div>
