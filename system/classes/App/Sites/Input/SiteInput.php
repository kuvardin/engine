...
class SiteInput
{
     ...
     */
    public function __construct(string $route, array $get, array $post, array $files, ?string $input, array $fields = [],
     ...
     */
    public function getSelectionData(int $total_amount, array $ord_variants = null, string $ord_default = null,
        string $sort_default = null, int $limit = null, bool $no_limit = null): SelectionData
    {
